...
class SurfacePointCloud:
    ...
    def sample_sdf_near_surface(self, number_of_points=500000, use_scans=True, sign_method='normal', normal_sample_count=11, min_size=0, return_gradients=False, near_scale=0.00025, far_scale=0.0025):
        query_points = []
        ...
        query_points.append(surface_points + np.random.normal(scale=far_scale, size=(surface_sample_count, 3)))
        query_points.append(surface_points + np.random.normal(scale=near_scale, size=(surface_sample_count, 3)))
